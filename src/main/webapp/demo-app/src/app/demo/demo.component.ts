...
export class DemoComponent implements OnInit {
    ...
    public message: any;
    public demodata: Demo = {"id": null, "name": null, "height": null, "message": new Message()};
    ...
    // 输入框的change事件调用以更新demo的msg
    updateMsg(value: string) {
        this.demodata.message.msg = value;
    }
